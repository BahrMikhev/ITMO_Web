              ...
              <div class="posts-section">
                ...
                <div class="posts-section-items">
                  <div class="post">
                    ...
                    <div class="post-body">
                      <div class="post-title"> Anon</div>
                      <div class="post-content">Check out, Mona Lisa from another culture!</div>
                    </div>
                  </div>
                  ...
                  <div class="post">
                    <div class="post-photo"></div>
                    <div class="post-body">
                      <div class="post-title"> Anon
                      </div>
                      <div class="post-content">Guess who?</div>
                    </div>
                  </div>
                </div>
              </div>
